...
document.addEventListener("DOMContentLoaded", () => {
	...
	// створення сцени з червоним кубом розміром 5 см
		...
		createRing (-0.5, 0.95, -0.5, 0.075, 0.1, 0xffff00); // Жовте кільце
		createRing (-0.5, 0.9, 	-0.5, 0.1,   0.125, 0xff00ff); // Рожеве кільце
		createRing (-0.5, 0.85, -0.5, 0.125, 0.15, 0x00ffff); // Блакитне кільце
		createRing (-0.5, 0.8, 	-0.5, 0.15,  0.175, 0xff0000); // Червоне кільце
		createRing (-0.5, 0.75, -0.5, 0.175, 0.2, 0x00ff00); // Зелене кільце
